...
public class MyRosMaster extends RosMaster {
    ...
    private boolean exec_test_mrs_topic_action_light_loop(Object[] args){
        ...
        float  max_deviation_from_path = 0.001f;
        boolean  dont_prepend_current_state = false;
        boolean  override_constraints = true;
        ...
        //handling of the array of points
        /*
        System.out.println("The first value of the array is: " + args[0]);
        ...
        //System.out.println("Array points = "+ array_points);
        //System.out.println("Array points[1] = "+ array_points[1]);
        //Object[] array_points = (Object[])args[1];
        for(int i=0;i<array_points.length;i++){
    ...
    private boolean exec_test_mrs_topic_action_light(Object[] args){
        ...
        for(int i=0;i<array_points.length;i++){
            ...
            float y = Float.parseFloat(array_position[1].toString());
            float z = Float.parseFloat(array_position[2].toString());
            float heading = Float.parseFloat(array_position[3].toString());
